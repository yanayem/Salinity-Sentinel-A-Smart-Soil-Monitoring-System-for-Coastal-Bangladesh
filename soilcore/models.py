...
class UserProfile(models.Model):
    ...
    profile_pic = models.ImageField(upload_to=user_directory_path, blank=True, null=True, default='profile_pics/default.png')
    phone_number = models.CharField(max_length=20, blank=True, null=True)
    location = models.CharField(max_length=100, blank=True, null=True)
    role = models.CharField(max_length=50, null=True, default="Soil Analyst")
...
# -----------------------------------------------
# SoilReading: Another user soil data model
# -----------------------------------------------
